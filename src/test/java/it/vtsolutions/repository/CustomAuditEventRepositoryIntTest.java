...
import it.vtsolutions.config.audit.AuditEventConverter;
import it.vtsolutions.domain.PersistentAuditEvent;
...
import static it.vtsolutions.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
